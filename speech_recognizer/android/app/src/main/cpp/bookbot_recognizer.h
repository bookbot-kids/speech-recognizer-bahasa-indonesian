...
#ifndef BOOKBOT_KALDI_RECOGNIZER_H
#define BOOKBOT_KALDI_RECOGNIZER_H
...
class BookbotRecognizer {
    public:
        BookbotRecognizer(BookbotModel *model, float sample_frequency);
        BookbotRecognizer(BookbotModel *model, float sample_frequency, char const *grammar);
        ~BookbotRecognizer();
...
#endif /* BOOKBOT_KALDI_RECOGNIZER_H */